...
export default function Sidebar() {
   return (
      <div className='p-4 font-sans text-base text-center bg-white rounded-2xl '>
         <img
         ...
         <p className='px-2 py-1 my-3 font-medium bg-gray-200 rounded-full'>
            Web Developer
         </p>
         {/* Resume */}
         <a
            download='resume.pdf'
            className='flex items-center justify-center px-2 py-1 my-2 bg-gray-300 rounded-full cursor-pointer'>
         ...
         <div
            className='py-2 my-4 bg-gray-300'
         ...
         {/* Email Button */}
         <button
            className='w-8/12 px-5 py-2 text-white rounded-full cursor-pointer'
            style={{
